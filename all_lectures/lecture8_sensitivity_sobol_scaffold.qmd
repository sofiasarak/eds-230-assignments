...
-   by increasing conductance/turbulence near the evaporation space increases evaporation, because it moves the evaporated droplets around and away, increasing evaporation

Atmospheric conductance is also influenced by the vegetation itself and the turbulence it creates

-   depends on structure of vegetation as well as wind speed

-   depends on height of veg as well as roughness

-   reason for more evaporation occurring over forests
...
# repeat sampling (run variables again) and call it X2
...
# which will add indices to sobol object   
...
sens_Catm_sobol$S
# wide CIs: maybe you need more samples
