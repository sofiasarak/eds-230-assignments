...
```{r}
result_test <- diff1(initialC = 10, nx = 10, dx = 1, nt = 8, dt = 1, D = 0.5, area = 10)
filled.contour(result_test$con, xlab = "Time", ylab = "Distance")
```
```{r}
filled.contour(result_test$qin, xlab = "Time", ylab = "Distance")
```
