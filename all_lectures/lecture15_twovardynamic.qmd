...
pmort has the highest value under the `original` column, meaning it has the highest effect on prey sensitivity

if confidence interval includes zero, we can confirm that they don't really affect maximum prey
