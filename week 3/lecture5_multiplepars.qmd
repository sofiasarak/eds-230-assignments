...
save(solar_annual_elect, file = here("week 3/annual_elect_solar.rda"))
...
```{r valuep, echo=TRUE}
source(here("week 3/compute_NPV.R"))
source(here("week 3/compute_profit_frompower.R"))
...
load(here("week 3/annual_elect_solar.rda"))
...
save(profit_solar, file = here("week 3/profit_solar.rda"))
```
