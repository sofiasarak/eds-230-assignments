...
load(here("week 2/data/sierraczosolar.rda"))
...
site2 <- eff %>% map(~ solarpv(area = 0.1, # map applies solarpv function with the arguments, to eff (df is specified in solar argument)
  solar = sierraczosolar, clr = "green", 
  eunit = "kWhr", g = FALSE, etype = "direct", eff = .x)) # .x tells the function to subsitute the argument for effiency to use what I am piping it from (aka eff)
